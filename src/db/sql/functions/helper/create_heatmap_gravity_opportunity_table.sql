...
CREATE OR REPLACE FUNCTION basic.create_heatmap_gravity_opportunity_table(
    ...
    geofence_table text, geofence_where_filter text, max_traveltime int, sensitivity float,
    potential_column text, where_filter text, result_table_name text, grid_resolution int,

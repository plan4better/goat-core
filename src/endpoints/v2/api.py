...
from . import folder, job, layer, project, report, system, user, active_mobility, motorized_mobility
...
router.include_router(
    active_mobility.router, prefix="/active_mobility", tags=["Active Mobility Indicators"]
)

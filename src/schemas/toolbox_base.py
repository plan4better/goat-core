...
class DefaultResultLayerName(str, Enum):
    ...
    join = "Join"
    isochrone_starting_points = "Starting Points - Isochrone"
    isochrone_active_mobility = "Isochrone"
    isochrone_pt = "Isochrone"
    isochrone_car = "Isochrone"
    oev_gueteklasse = "ÖV-Güteklassen"
    oev_gueteklasse_station = "ÖV-Güteklasse Station"
    trip_count_station = "Trip Count Station"
    nearby_station_access_starting_points = "Starting Points - Nearby Stations"

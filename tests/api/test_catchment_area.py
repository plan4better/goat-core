...
@pytest.mark.parametrize(
    ...
    [
        (
            "point_single", CatchmentAreaRoutingModeActiveMobility.walking, {"max_traveltime": 15, "speed": 5, "steps": 3},
            CatchmentAreaTypeActiveMobility.polygon, False,
        ),
        (
            "point_multiple", CatchmentAreaRoutingModeActiveMobility.walking, {"max_distance": 500, "steps": 5},
            CatchmentAreaTypeActiveMobility.network, None,
        ),
        (
            "point_layer", CatchmentAreaRoutingModeActiveMobility.walking, {"max_traveltime": 37, "speed": 4, "steps": 22},
            CatchmentAreaTypeActiveMobility.rectangular_grid, None,
        ),
        (
            "point_single", CatchmentAreaRoutingModeActiveMobility.walking, {"max_distance": 15000, "steps": 8},
            CatchmentAreaTypeActiveMobility.polygon, True,
        ),
        (
            "point_multiple", CatchmentAreaRoutingModeActiveMobility.bicycle, {"max_traveltime": 5, "speed": 15, "steps": 3},
            CatchmentAreaTypeActiveMobility.polygon, False,
        ),
        (
            "point_layer", CatchmentAreaRoutingModeActiveMobility.bicycle, {"max_distance": 4300, "steps": 6},
            CatchmentAreaTypeActiveMobility.network, None,
        ),
        (
            "point_single", CatchmentAreaRoutingModeActiveMobility.bicycle, {"max_traveltime": 20, "speed": 11, "steps": 19},
            CatchmentAreaTypeActiveMobility.rectangular_grid, None,
        ),
        (
            "point_multiple", CatchmentAreaRoutingModeActiveMobility.bicycle, {"max_distance": 7250, "steps": 9},
            CatchmentAreaTypeActiveMobility.polygon, True,
        ),
        (
            "point_layer", CatchmentAreaRoutingModeActiveMobility.pedelec, {"max_traveltime": 7, "speed": 23, "steps": 3},
            CatchmentAreaTypeActiveMobility.polygon, False,
        ),
        (
            "point_single", CatchmentAreaRoutingModeActiveMobility.pedelec, {"max_distance": 900, "steps": 4},
            CatchmentAreaTypeActiveMobility.network, None,
        ),
        (
            "point_multiple", CatchmentAreaRoutingModeActiveMobility.pedelec, {"max_traveltime": 28, "speed": 7, "steps": 28},
            CatchmentAreaTypeActiveMobility.rectangular_grid, None,
        ),
        (
            "point_layer", CatchmentAreaRoutingModeActiveMobility.pedelec, {"max_distance": 2400, "steps": 3},
            CatchmentAreaTypeActiveMobility.polygon, True,
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "point_single",
            [
                CatchmentAreaRoutingModePT.bus, CatchmentAreaRoutingModePT.tram,
                CatchmentAreaRoutingModePT.subway, CatchmentAreaRoutingModePT.rail,
            ],
            CatchmentAreaRoutingAccessModePT.walk, CatchmentAreaRoutingEgressModePT.walk,
            30, 5, PTSupportedDay.weekday, 25200, 32400, CatchmentAreaTypePT.polygon, True,
        ),
        (
            "point_single",
            [
                CatchmentAreaRoutingModePT.rail, CatchmentAreaRoutingModePT.gondola,
                CatchmentAreaRoutingModePT.ferry, CatchmentAreaRoutingModePT.funicular,
            ],
            CatchmentAreaRoutingAccessModePT.walk, CatchmentAreaRoutingEgressModePT.walk,
            72, 8, PTSupportedDay.saturday, 41400, 54000, CatchmentAreaTypePT.polygon, False,
        ),
        (
            "point_single",
            [
                CatchmentAreaRoutingModePT.tram, CatchmentAreaRoutingModePT.ferry,
                CatchmentAreaRoutingModePT.cable_car, CatchmentAreaRoutingModePT.rail,
            ],
            CatchmentAreaRoutingAccessModePT.walk, CatchmentAreaRoutingEgressModePT.walk,
            21, 7, PTSupportedDay.sunday, 3600, 14400, CatchmentAreaTypePT.polygon, True,
        ),
        (
            "point_single",
            [
            ...
            CatchmentAreaRoutingAccessModePT.walk, CatchmentAreaRoutingEgressModePT.walk,
            11, 10, PTSupportedDay.weekday, 57600, 59400, CatchmentAreaTypePT.polygon, False,
        ),
        (
            "point_single",
            [
                CatchmentAreaRoutingModePT.bus, CatchmentAreaRoutingModePT.tram,
                CatchmentAreaRoutingModePT.rail, CatchmentAreaRoutingModePT.subway,
                CatchmentAreaRoutingModePT.ferry, CatchmentAreaRoutingModePT.cable_car,
                CatchmentAreaRoutingModePT.gondola, CatchmentAreaRoutingModePT.funicular,
            ],
            CatchmentAreaRoutingAccessModePT.walk, CatchmentAreaRoutingEgressModePT.walk,
            90, 9, PTSupportedDay.saturday, 25200, 32400, CatchmentAreaTypePT.polygon, True,
        ),
        (
            "point_single",
            [
            ...
            CatchmentAreaRoutingAccessModePT.walk, CatchmentAreaRoutingEgressModePT.walk,
            47, 17, PTSupportedDay.sunday, 21600, 72000, CatchmentAreaTypePT.polygon, False,
        ),
    ],
)
